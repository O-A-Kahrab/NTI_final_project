"""
Advanced File and Folder Search Engine
===========================================
تم تنظيم هذا الملف بحيث يكون كل الكود غير المرتبط بالواجهة الرسومية
(GUI) في الأعلى، وكل كود الواجهة الرسومية (Tkinter) مجمّع في النهاية.
"""
...
# ==== مكتبات اختيارية (البرنامج يجب أن يعمل حتى لو لم تكن مثبتة) ====
try:
